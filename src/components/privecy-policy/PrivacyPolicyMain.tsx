              ...
              <div className="tab-content mb-60">
                ...
                >
                  <div className="terms_conditions_content">
                    ...
                    <p>
                      At <strong>Ecomart</strong>, we value your privacy and are
                    ...
                    <p>
                      As a provider of the Ecomart -eCommerce you may collect
                      and{" "}
                    ...
                    <ul className="icon_list  unordered_list_block">
                      <li>
                        <span className="list_item_text">
                          <strong>1. Personal Information:</strong> When you
                          create an account or make a purchase, we may collect
                          your name, email address, shipping address, and
                          payment details to provide you with our services.
                        </span>
                      </li>
                      <li>
                        <span className="list_item_text">
                          <strong>2. Browsing Data:</strong> We may collect
                          information about your browsing behavior on our
                          website to improve our product recommendations and
                          enhance your shopping experience.
                        </span>
                      </li>
                      <li>
                        <span className="list_item_text">
                          <strong>3. Cookies and Tracking:</strong> We use
                          cookies and tracking technologies to gather data about
                          your interactions with our website, such as pages
                          visited and products viewed. This information helps us
                          tailor our offerings to your preferences and
                          interests.
                        </span>
                      </li>
                      <li>
                        <span className="list_item_text">
                          ...
                          third-party services may require us to post Privacy
                          Policy agreements on our website to comply with their
                    ...
                    <p>
                      <Link className="link" href="Ecomartadmin@gmail.com">
